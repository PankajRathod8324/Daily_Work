...
public class OrderService : IOrderService
{
    ...
    public OrderVM GetOrderByOrderId(int orderId)
    {
        ...
        var orderVM = new OrderVM
        {
            ...
            // PlacedOn = (DateTime)selectedorder.PlacedOn != null ? (DateTime)selectedorder.PlacedOn : DateTime.Now,
            // ModifiedOn = payment.ModifiedAt != null ? payment.ModifiedAt : DateTime.Now,
